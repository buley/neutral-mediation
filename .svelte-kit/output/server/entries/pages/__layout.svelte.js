import { g as getContext, c as create_ssr_component, e as escape, a as each, b as add_attribute, v as validate_component, d as subscribe, f as add_classes } from "../../chunks/index-75d4f4f2.js";
const getStores = () => {
...
<footer><a sveltekit:prefetch href="${"/"}" class="${"footer-icon"}"><img${add_attribute("src", logo, 0)} alt="${"Neutral Mediation Home"}" height="${"64px"}" width="${"64px"}"></a>
	<ul class="${"menu-navigation"}"><li${add_classes(($page.url.pathname === "/about" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/about"}">About</a></li>
	    <li${add_classes(($page.url.pathname === "/cancellation" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/cancellation"}">Cancellation</a></li>
	    ...
	    <li${add_classes(($page.url.pathname === "/disclaimers" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/disclaimers"}">Disclaimers</a></li>
	    <li${add_classes(($page.url.pathname === "/documents" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/documents"}">Documents</a></li>
	    <li${add_classes(($page.url.pathname === "/ethics" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/ethics"}">Ethics</a></li>
	    <li${add_classes(($page.url.pathname === "/neutrals" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/neutrals"}">Neutrals</a></li>
	    <li${add_classes(($page.url.pathname === "/news" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/news"}">News</a></li>
	    <li${add_classes(($page.url.pathname === "/press" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/press"}">Press</a></li>
	    ...
	    <li${add_classes(($page.url.pathname === "/terms" ? "active" : "").trim())}><a sveltekit:prefetch href="${"/terms"}">Terms of Service</a></li></ul>
