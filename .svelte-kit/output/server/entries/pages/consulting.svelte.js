...
const Consulting = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Consulting</title>`, ""}<meta name="${"description"}" content="${"About Neutral Mediation conflict consulting services."}" data-svelte="svelte-13q31h4">`, ""}
