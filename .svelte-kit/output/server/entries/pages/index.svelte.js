...
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>Neutral Mediation - Northern California Mediation</title>`, ""}<meta name="${"description"}" content="${"Neutral Mediation minimizes the emotional trauma, time and expense associated with complex conflict through the practice of neutral-led mediation and negotiation, in addition to training, consulting nad conflict coaching."}" data-svelte="svelte-1ee1jh4">${validate_component(MetaTags, "MetaTags").$$render($$result, {
