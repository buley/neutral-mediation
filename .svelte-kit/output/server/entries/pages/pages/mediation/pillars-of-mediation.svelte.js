...
var pillarsOfMediation_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".content.svelte-cf77e8{width:100%;max-width:var(--column-width);margin:var(--column-margin-top) auto 0 auto}")();
const css = {
...
const Pillars_of_mediation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Pillars of Mediation</title>`, ""}<meta name="${"description"}" content="${""}" data-svelte="svelte-nxs12f">`, ""}

<div class="${"content svelte-cf77e8"}"><h1>Pillars of Mediation</h1>
...
export { Pillars_of_mediation as default, hydrate, prerender, router };
