...
var whatMediationIs_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".content.svelte-cf77e8{width:100%;max-width:var(--column-width);margin:var(--column-margin-top) auto 0 auto}")();
const css = {
...
<div class="${"content svelte-cf77e8"}"><h1>What Mediation Is</h1>
	...
	<p><a href="${"/ethics"}">Read our ethics for Neutral Mediation\u2019s views on the importance of neutrality and self-determination in mediation.</a></p>

</div>`;
});
export { What_mediation_is as default, hydrate, prerender, router };
