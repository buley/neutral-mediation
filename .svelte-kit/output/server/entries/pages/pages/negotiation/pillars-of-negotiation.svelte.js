...
var pillarsOfNegotiation_svelte_svelte_type_style_lang = /* @__PURE__ */ (() => ".content.svelte-cf77e8{width:100%;max-width:var(--column-width);margin:var(--column-margin-top) auto 0 auto}")();
const css = {
...
const Pillars_of_negotiation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Pillars of Negotiation</title>`, ""}<meta name="${"description"}" content="${""}" data-svelte="svelte-l6kr50">`, ""}

<div class="${"content svelte-cf77e8"}"><h3>Pillars of Negotiation</h3>
	
	<p>The pillars of mediation are that it&#39;s voluntary and neutral.
	</p>
...
export { Pillars_of_negotiation as default, hydrate, prerender, router };
