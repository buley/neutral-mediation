...
const Prices = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Prices</title>`, ""}<meta name="${"description"}" content="${""}" data-svelte="svelte-cjo95p">`, ""}
...
<div class="${"content svelte-cf77e8"}"><h1>Prices</h1>
	...
	<div class="${"wp-block-columns alignwide"}"><div class="${"wp-block-column"}"><p><strong>Mediation Consultation<br></strong><em><em>A brief, typically one- to four-hour virtual session of mediation or conflict coaching.</em> </em><br>$175/hour</p></div>
	...
	<ul><li><a href="${"/availability"}">Availability</a></li></ul>
