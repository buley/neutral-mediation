export const manifest = {
	...
	_: {
		entry: {"file":"start-94cbbf5a.js","js":["start-94cbbf5a.js","chunks/index-2c309845.js"],"css":[]},
		nodes: [
			() => import('./nodes/0.js'),
			() => import('./nodes/1.js'),
			() => import('./nodes/28.js'),
		...
		routes: [
			...
			{
				type: 'page',
				id: "pages/quotes/politics",
				pattern: /^\/pages\/quotes\/politics\/?$/,
				names: [],
				types: [],
				path: "/pages/quotes/politics",
				shadow: null,
				a: [0,91],
				b: [1]
			},
