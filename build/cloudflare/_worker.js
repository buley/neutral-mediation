...
// build/output/server/chunks/index-f900b887.js
function noop() {
}
function run(fn) {
  return fn();
...
// build/output/server/chunks/hooks-93fa095d.js
...
// build/output/server/chunks/phone-f0b0e6b3.js
var phone;
var init_phone_f0b0e6b3 = __esm({
  "build/output/server/chunks/phone-f0b0e6b3.js"() {
    phone = "/_app/immutable/assets/phone-f95f4186.svg";
  }
});

// build/output/server/entries/pages/__layout.svelte.js
var layout_svelte_exports = {};
__export(layout_svelte_exports, {
  default: () => _layout
});
var getStores, page, logo$1, calendar, css$2, Button, css$1, Navi, HamburgerMenu, css, Header, logo, email, _layout;
var init_layout_svelte = __esm({
  "build/output/server/entries/pages/__layout.svelte.js"() {
    ...
    Navi = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { open } = $$props;
      let { menu_list } = $$props;
...
// build/output/server/nodes/0.js
var __exports = {};
__export(__exports, {
  css: () => css2,
  entry: () => entry,
...
var init__ = __esm({
  "build/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    entry = "pages/__layout.svelte-fa0bc2ba.js";
    js = ["pages/__layout.svelte-fa0bc2ba.js", "chunks/index-ebfde0cd.js", "chunks/phone-f0b0e6b3.js"];
    css2 = ["assets/pages/__layout.svelte-62ab5b47.css"];
  }
});

// build/output/server/entries/fallbacks/error.svelte.js
...
// build/output/server/nodes/1.js
var __exports2 = {};
__export(__exports2, {
  css: () => css3,
  entry: () => entry2,
...
var init__2 = __esm({
  "build/output/server/nodes/1.js"() {
    init_error_svelte();
    index2 = 1;
    entry2 = "error.svelte-58034301.js";
    js2 = ["error.svelte-58034301.js", "chunks/index-ebfde0cd.js"];
    css3 = [];
  }
});

// build/output/server/entries/endpoints/sitemap.xml.js
...
// build/output/server/entries/endpoints/random.js
var random_exports = {};
...
function parse2(input, options) {
  ...
  if (!options.map) {
    ...
    return input.filter(isNonEmptyString).reduce(function(cookies2, str) {
      var cookie3 = parseString(str, options);
      ...
      fetch: async (resource, opts = {}) => {
        ...
        if (is_asset || is_asset_html) {
          ...
          if (opts.credentials !== "omit") {
            ...
            const cookie3 = Object.entries(combined_cookies).map(([name, value]) => `${name}=${value}`).join("; ");
            if (cookie3) {
              opts.headers.set("cookie", cookie3);
            }
          ...
          if (`.${new URL(requested).hostname}`.endsWith(`.${event.url.hostname}`) && opts.credentials !== "omit") {
            uses_credentials = true;
            const cookie3 = event.request.headers.get("cookie");
            if (cookie3)
              opts.headers.set("cookie", cookie3);
          }
...
// build/cloudflare-tmp/manifest.js
var manifest = {
  appDir: "_app",
  assets: /* @__PURE__ */ new Set(["FavIcon.png", "Icon.png", "Icon.svg", "robots.txt"]),
    ...
    routes: [
      {
        ...
        names: [],
        types: [],
        load: () => Promise.resolve().then(() => (init_sitemap_xml(), sitemap_xml_exports))
      },
      {
        type: "endpoint",
        id: "random",
        ...
        names: [],
        types: [],
        load: () => Promise.resolve().then(() => (init_random(), random_exports))
      }
    ],
    matchers: async () => {
      return {};
...
var prerendered = /* @__PURE__ */ new Set(["/", "/about", "/availability", "/background", "/cancellation", "/coaching", "/consulting", "/contact", "/cookies", "/disclaimer", "/documents", "/ethics", "/key", "/mediation", "/negotiation", "/news", "/press", "/prices", "/privacy", "/recusal", "/refunds", "/resume", "/security", "/terms", "/thanks", "/training", "/w9", "/forms/arrogance", "/forms/autopilot", "/forms/coaching", "/forms/collaboration", "/forms/communication", "/forms/conflict", "/forms/courage", "/forms/emotional", "/forms/goals", "/forms/honesty", "/forms/layered", "/forms/positive", "/forms/role-reversal", "/forms/root", "/forms/self-assessment", "/pages/quotes", "/pages/coaching/acceptance", "/pages/coaching/apology", "/pages/coaching/benefits-of-conflict-coaching", "/pages/coaching/breathwork", "/pages/coaching/cbt", "/pages/coaching/conflict-coaching-process", "/pages/coaching/emotions", "/pages/coaching/empathy", "/pages/coaching/example-conflict-coaching-scenarios", "/pages/coaching/forgiveness", "/pages/coaching/gratitude", "/pages/coaching/humility", "/pages/coaching/limitations-of-conflict-coaching", "/pages/coaching/meditation", "/pages/coaching/mindset-assessment", "/pages/coaching/pillars-of-conflict-coaching", "/pages/coaching/rebt", "/pages/coaching/relationships", "/pages/coaching/what-is-conflict-coaching", "/pages/mediation/benefits-of-mediation", "/pages/mediation/example-mediation-provisions", "/pages/mediation/example-mediation-scenarios", "/pages/mediation/how-mediators-create-value", "/pages/mediation/how-to-involve-a-neutral", "/pages/mediation/limits-of-mediation", "/pages/mediation/mediation-best-practices", "/pages/mediation/mediation-confidentiality", "/pages/mediation/mediation-law", "/pages/mediation/mediation-process", "/pages/mediation/pillars-of-mediation", "/pages/mediation/what-a-mediator-does", "/pages/mediation/what-mediation-is", "/pages/mediation/who-mediators-are", "/pages/mediation/why-a-mediator-is-worthwhile", "/pages/negotiation/benefits-of-negotiation", "/pages/negotiation/example-negotiation-scenarios", "/pages/negotiation/limitations-of-negotiation", "/pages/negotiation/pillars-of-negotiation", "/pages/negotiation/what-is-negotiation", "/pages/quotes/attitude", "/pages/quotes/civics", "/pages/quotes/coaching", "/pages/quotes/emotion", "/pages/quotes/forgiveness", "/pages/quotes/hope", "/pages/quotes/mediation", "/pages/quotes/negotiation", "/pages/quotes/reflection", "/pages/quotes/storytelling", "/sitemap.xml"]);

// build/cloudflare-tmp/_worker.js
