...
<div class="content">
	...
	<p>Taylor Buley founded Neutral Mediation to minimize the financial and energy cost, time and trauma associated with handling complex disputes. As a professional third-party neutral, Taylor strives to create an environment of trust, openness and psychological safety in which he offers mediation, negotiation, consulting, training and conflict coaching services.</p>
