...
<div class="content">
	...
	<h2>Our Practice</h2>
	<p>
		Neutral Mediation offers invididuals flexibly-scheduled virtual conflict coaching sessions &mdash creating and executing personal goals amid internal or external conflict. The coaching is led by a trained professional neutral and typically ongoing for a short period, until a client is comfortable practicing the conflict resolution techniques that empower them to move forward. <em>Conflict coaching sessions cost $175 per hour per participant.</em> For neutral-led mediation sessions, see our <a href="/mediation">mediation page</a>. For neutral-led negotiation sessions, see our <a href="/negotiation">negotiation page</a>. For mediation and negotiation training, see our <a href="/training">training page</a>. For mediation, negotiation and conflict consulting for organizations, see our <a href="/consulting">consulting page</a>.
	</p>
	<h2>Our Value</h2>
	<p>
		There is so much untapped potential, and, as a result, so much conflict in the work to achieve it. Conflict coaching is a tested and effective approach to improving performance in our personal or executive lives. Conflict coaching empowers invididuals to feel more confident and make hard more decisions more rationally even when faced with opportunities for growth. With the help of a third-party service like Neutral Mediation, a client can learn and practice skills, techniques, and appraoches to conflict that minimize anxiety and worrying, stop self-sabotaging behaviors, and put an end to procrastination. Under the help and accountability of a trained coaching professional, dedicated to your progress, a conflict coach can help people better manage the human but negative emotions that bear corporial witness to conflict via stress and unhappiness.
	</p>
	<p>
